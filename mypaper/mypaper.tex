...
\par
\textbf{Hitting time}£ºhitting time [Reversible Markov Chains] can be considered as a weighted path length from I to j. The mathematic definition of hitting time is as follows:
%\begin{equation}
\begin{comment}
\[ h_{ij} =
\begin{cases}
...
There are many literature  of quantum networks\cite{The DARPA quantum network}\cite{Outline of the SECOQC quantum-keydistribution
